...
pathOutput = "C:\\Users\\Admin\\Documents\\coding\\label\\outputs\\"
...
frameList = []
nameList = os.listdir("C:\\Users\\Admin\\Documents\\coding\\label\\tu")

# nameList = ["1520.png"]

for name in nameList:
  frame = cv2.imread("C:\\Users\\Admin\\Documents\\coding\\label\\tu\\"+name)
...
while True:
  ...
  cv2.imwrite(pathOutput+"image\\tu-"+nameList[counter],frame)
  cv2.imwrite(pathOutput+"label\\tu-"+nameList[counter],label)
  polyPoint = []
  # Break the loop
  # break
